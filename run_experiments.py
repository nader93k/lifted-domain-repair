...
def experiment(search_algorithm, benchmark_path, log_folder, log_interval, specific_instance=None):
    ...
    for instance in instance_list:
        ...
        searcher = search_algorithm(initial_node)
        try:
...
if __name__ == "__main__":
    ...
    experiment(search_algorithm=AStar
