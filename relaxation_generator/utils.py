...
def parse_arguments():
    ...
    parser.add_argument('--domain-print', default='', help=".pddl domain output file.")
    parser.add_argument('--problem-print', default='', help=".pddl problem output file.")
    ...
    parser.add_argument('--r-mode', default='none', help="Select relaxation.", choices=['none', 'zeroary', 'unary'])
