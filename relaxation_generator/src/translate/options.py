...
def parse_args():
    ...
    argparser.add_argument(
        "--integrate-add-del-to-pre", action="store_true",
        help="adds add and del elements to datalog rule bodies")
    argparser.add_argument(
        "--integrate-action-cost", action="store_true",
        help="annotates actions with cost")
